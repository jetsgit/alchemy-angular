...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Provides Rails generators and Angular controllers, services and directives for seamless integration of AlchemyCMS within your AngularJS powered one page frontend app.}
  spec.homepage      = ""
  spec.license       = "BSD"
  ...
  spec.add_runtime_dependency "alchemy_cms", ">= 3.1.0.beta1"
